...
BOX_SIZE = 40
BOX_COUNT = 50       # <-- you get to fifty of them by the end of today
SPEED = 240
# ------------------------------------------------
...
pygame.display.set_caption("Session 13")
clock = pygame.time.Clock()

# One box needs four separate names. Two boxes would need eight.
box_x = 100.0
box_y = 60.0
box_vx = SPEED
box_vy = SPEED
